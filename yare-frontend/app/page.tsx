...
export default function LandingPage() {
  return (
    ...
    >
      ...
      {/* Nav */}
      <nav className="flex items-center px-12 py-5 z-10 relative">
      ...
      <div className="flex-1 flex flex-col items-center justify-center z-10 relative px-12 text-center pb-16">
        ...
        {/* ロゴ */}
        <div
          className="text-[80px] font-bold text-white mb-3 leading-none"
        ...
        {/* キャッチコピー */}
        <h1
          className="text-[44px] font-bold text-white leading-[1.2] mb-6 text-center"
        ...
        <p className="text-[14px] mb-9 leading-[1.9]" style={{ color: 'rgba(255,255,255,0.45)' }}>
        ...
        <div className="flex gap-10 mt-14 pt-8" style={{ borderTop: '0.5px solid rgba(255,255,255,0.08)' }}>
      ...
      <div className="relative z-10 px-12 pb-20">
        <div className="max-w-3xl mx-auto">
          ...
          {/* 4つの痛み — 高さを揃え、折り返しも自然に */}
          <div className="grid grid-cols-2 gap-3 mb-12">
            {[
              { icon: '😩', text: '学習を始めても、3日も経たずにやめてしまった' },
              { icon: '📅', text: '「明日からやろう」を何度も繰り返している' },
              { icon: '💸', text: '高い受講料を払ったのに、結局ほとんど続かなかった' },
              { icon: '🤔', text: '意志の力だけでは継続できないと、薄々気づいている' },
            ].map(({ icon, text }) => (
              <div
                key={text}
